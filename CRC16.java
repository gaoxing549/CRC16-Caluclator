/* Jonathan Carelli
 * CIS3360 0R02 -- Fall 2013
 * Program #2 - CRC-16 calculator and verifier
 * Due: 11/15/2013 */
...
public class CRC16 {
	...
	// Running the crc verification case
		if(input == 'v'){
			...
			String crcInit = "10000100110001101";
			...
			System.out.println();
			System.out.println("The polynomial that was used (bin): 1 0000 1001 1000 1101");
	...
	// Runing the crc calculation case
			...
			System.out.println();
			System.out.println();
			System.out.print("The polynomial that was used (binary bit string): 1 0000 1001 1000 1101");
			System.out.println();
			System.out.println();
